const locales = {
    vi: {
        ...
        layer_series_group_not_found: 'Không tìm thấy nhóm layer time-series',
        layer_series_invalid_years: 'year_from/year_to không hợp lệ',
        layer_series_file_required: 'Vui lòng đính kèm file GeoTIFF',
        layer_series_invalid_tiff: 'File không phải GeoTIFF hợp lệ',
        layer_series_data_dir_missing: 'Thư mục mosaic chưa được cấu hình (GEOSERVER_DATA_DIR)',
        layer_series_granule_exists: 'Mốc năm/giai đoạn này đã tồn tại trong nhóm',
        layer_series_ingest_success: 'Đã thêm ảnh vào chuỗi thời gian',
        layer_series_groups_list_success: 'Lấy danh sách nhóm layer time-series thành công',
        layer_series_timesteps_success: 'Lấy danh sách mốc thời gian thành công',
     ...
     en: {
        ...
        layer_series_invalid_years: 'Invalid year_from/year_to',
        layer_series_file_required: 'Please attach a GeoTIFF file',
        layer_series_invalid_tiff: 'File is not a valid GeoTIFF',
        layer_series_data_dir_missing: 'Mosaic storage directory not configured (GEOSERVER_DATA_DIR)',
        layer_series_granule_exists: 'This year/period already exists in the group',
        layer_series_ingest_success: 'Granule added to time series',
        layer_series_groups_list_success: 'Layer group list retrieved successfully',
        layer_series_timesteps_success: 'Timesteps retrieved successfully',
