const locales = {
    vi: {
        ...
        mobile_field_update_created_success: 'Cập nhật đối tượng thành công',
        mobile_field_update_geometry_unsupported: 'Chỉ hỗ trợ cập nhật đối tượng trên layer điểm (POINT/MULTIPOINT)',
        mobile_field_update_invalid_attributes: 'Thuộc tính không hợp lệ. Các cột được phép: {columns}',
        mobile_sync_success: 'Đồng bộ dữ liệu thành công',
     ...
     en: {
        ...
        mobile_field_update_created_success: 'Field update applied successfully',
        mobile_field_update_geometry_unsupported: 'Field updates are only supported on point layers (POINT/MULTIPOINT)',
        mobile_field_update_invalid_attributes: 'Invalid attributes. Allowed columns: {columns}',
        mobile_sync_success: 'Data synced successfully',
